...
const BOSS_BAR = preload("res://HealthBar.tscn")
var barra_boss = null
...
func _ready():
	...
	barra_boss = BOSS_BAR.instantiate()
	get_tree().current_scene.add_child(barra_boss)

	barra_boss.configurar(self, "Jubis Creudo")
